...
```{r}
<<<<<<< HEAD
subset2 <- subset2 |> data.table::setkey(index)
data.table::key(subset2)

subset3 <- dt |> def_cols(index = .I) |> filter_rows(mpg > 18) |> sel_cols(index, `vehicle model`, drat, am, carb) |> data.table::setkey(index)
subset3

subset2[subset3]
=======
mkdt()
>>>>>>> c006890c5aa24e4641c8e153a32d50e9db0aa7b5
```
